...
import TarobResults from "./TarobResults";

export default function TarobReviewPage({ setOpenLogDetails }) {
  const { id } = useParams();
    ...
    const fetchAnalysisDetails = async () => {
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_BASE_API}/user/analysis/tarobPrep/analysis-details/${id}`,
          {
            method: "GET",
  ...
  console.log("Data at TarobPrep: ", analysisRecord)
